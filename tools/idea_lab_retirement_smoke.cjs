...
assert(html.includes('id="panel-memos"'));
const app=fs.readFileSync(path.join(root,'app.js'),'utf8');
assert(app.includes('if (legacyIdeas || legacyKnowledge) view = "memos";'));
assert(app.includes('new CustomEvent("studyflow:legacy-ideas")'));
const knowledge=fs.readFileSync(path.join(root,'memos.js'),'utf8');
