...
func (s *Service) ExportUserData(ctx context.Context, userID string) (UserDataExport, error) {
	...
	if bundle.Explorations, err = s.ListExplorations(ctx, userID); err != nil {
		return UserDataExport{}, err
	}
	if bundle.Keepsakes, err = s.repo.ListKeepsakes(ctx, userID); err != nil {
		return UserDataExport{}, err
	}
	...
	if bundle.TravelPlans, err = s.repo.ListTravelPlans(ctx, userID); err != nil {
		return UserDataExport{}, err
	}
